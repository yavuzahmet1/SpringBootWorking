...
public class LJEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LJEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LJEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LJEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LJEDateTimeConverter dateTimeConverter = new LJEStandardDateTimeConverter();

    public LJEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LJEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LJEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LJEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LJEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LJEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
