...
public class LJEKPSPublicSoap
{
    ...
    public LJEKPSPublicSoap(){}

    public LJEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LJEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LJEExtendedSoapSerializationEnvelope envelope= new LJEExtendedSoapSerializationEnvelope(LJEExtendedSoapSerializationEnvelope.VER11);
