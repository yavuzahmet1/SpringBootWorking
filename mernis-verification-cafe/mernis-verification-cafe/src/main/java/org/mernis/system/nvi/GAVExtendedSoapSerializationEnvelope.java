...
public class GAVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GAVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GAVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GAVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GAVDateTimeConverter dateTimeConverter = new GAVStandardDateTimeConverter();

    public GAVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GAVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GAVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GAVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GAVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GAVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
