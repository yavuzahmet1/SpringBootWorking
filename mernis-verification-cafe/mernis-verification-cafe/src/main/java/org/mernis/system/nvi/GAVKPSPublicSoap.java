...
public class GAVKPSPublicSoap
{
    ...
    public GAVKPSPublicSoap(){}

    public GAVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GAVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GAVExtendedSoapSerializationEnvelope envelope= new GAVExtendedSoapSerializationEnvelope(GAVExtendedSoapSerializationEnvelope.VER11);
